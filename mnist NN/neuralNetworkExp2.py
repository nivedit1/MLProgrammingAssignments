...
def weight_update(deltaHidden,deltaOutput,weights,weightsHidden,trainingHidden,inputData,delWeights,delWeightsHidden,a):
    """
    ...
    hiddenMomentum = a * delWeightsHidden
...
def dual_plot_accuracy(trainingAccuracy, testingAccuracy, a):
    """
    ...
    plt.title('Training vs Testing Accuracy with ' + str(a) +  ' momentum' )
    lgd = plt.legend(loc=9, bbox_to_anchor=(0.5, -0.1),ncol=2)
    plt.savefig('Exp2_training_vs_testing_neuralNet_with_alpha_'+str(a)+'.png',bbox_extra_artists=(lgd,), bbox_inches='tight')
...
if __name__ == '__main__':
    ...
    for a in ALPHA:
        ...
        for epoch in range(0,50):
            ...
            for x in range(0, len(trainingInputImgArray)):
                ...
                if(epoch > 0):
                    ...
                    weights, weightsHidden, delWeights, delWeightsHidden = weight_update(deltaHidden,deltaOutput,weights,weightsHidden,trainingHidden,inputArray,delWeights, delWeightsHidden,a)
        ...
        print("Confusion Matrix for the test data for momentum: ",a)
        print(confusionMatrix)

        # Plot training vs test accuracy for each experiment
        dual_plot_accuracy(trainingAccuracyArray, testAccuracyArray, a)
        plt.close()
